  ...
  return (
    <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-950">
      <p className="font-semibold">
        Pending order {pending.displayOrderId ?? pending.orderId} — complete Razorpay payment
      </p>
      <p className="mt-1 text-xs text-amber-900/80">
        Finish payment to confirm your order. You can still edit your cart below if needed.
      </p>
      <Link
